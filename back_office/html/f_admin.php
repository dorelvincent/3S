		...
		<div id="corps">
			...
			<div id="content">
				...
				<div id="bloc_main">
					<div id="bloc_tool">
						<p><input type='button' onclick="location.href ='../Traitements/t_liste_promo.php';";" value="Promotions" id="promotions" class="button"/>
						<input type='button' onclick="location.href ='../Traitements/t_liste_news.php';" value="News" ; id="news" class="button"/>
						<input type='button' onclick="location.href ='../Traitements/t_liste_categorie.php';" value="Catégories" id="categories" class="button"/></p>
						
						<p><input type='button' onclick="location.href ='../Traitements/t_liste_produit.php';" value="Produits" id="produits" class="button"/>
						<input type='button' onclick="location.href ='../Traitements/t_liste_client.php';" value="Clients" id="clients" class="button"/>
						<input type='button' onclick="window.open('commandes.php');" value="Commandes" id="commandes" class="button"/></p>
					</div>
